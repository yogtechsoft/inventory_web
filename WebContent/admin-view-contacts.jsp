	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">View Sales Product</h4>
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="panel panel-success">
						<div class="panel-heading">View Sales Item</div>
						<div class="panel-body">
							<div class="table-responsive">
								<table class="table table-striped table-bordered table-hover">
									...
									<%
									ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from tbl_sale_product_details");
									while (rs.next()) {
									%>
									<tbody>
										<tr>
											...
											<td><%=rs.getString("sale_quantity")%></td>
