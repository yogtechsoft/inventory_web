...
public class DatabaseConnection {
	...
	public static Connection getConnection() {
		try {
			...
			connection = DriverManager.getConnection("jdbc:mysql://localhost/ims?useSSL=false", "root", "Abhishek@1993");
			//connection = DriverManager.getConnection("jdbc:mysql://localhost/jarandes_onlineshop?useSSL=false", "jarandes_shopuser", "Abhishek@1993");
